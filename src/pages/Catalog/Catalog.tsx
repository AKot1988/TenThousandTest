...
const Catalog: FC = () => {
  ...
  useEffect(() => {
    fetchItems('../../../public/dataJSON/solarPanel.json').then((data) =>
      setData(data)
    );
  }, []);
  return (
    <>
      <div className={classes.catalog}>
        <svg onClick={()=>{setModalCart({modalCartVisible: true, itemToRender: Cart})}}  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
